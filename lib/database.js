...
const DB_PATH = path.join(process.cwd(), 'data', 'o_easy_ta.db');
const STUDENTS_PHOTOS_PATH = path.join(process.cwd(), 'data', 'students');
const BARCODES_PATH = path.join(process.cwd(), 'data', 'barcodes');
const ID_CARDS_PATH = path.join(process.cwd(), 'data', 'id_cards');
